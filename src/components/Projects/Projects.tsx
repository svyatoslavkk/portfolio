    ...
    <section className="default-section">
      <h2 className="title">Projects I've<br /> Worked on</h2>
        {projects.map((el: IProject) => (
          <div key={el?.name} className="card" style={{backgroundColor: el?.bgColor }}>
            {el && (
              <>
              ...
              <div className="card-info">
                ...
                <div className="buttons-content">
                  ...
                  {el?.demoLink && (
                    <a href={el?.demoLink} className="yellow-btn" target="_blank" rel="noopener noreferrer">
                      <OpenInNewIcon sx={{color: "#110f0f"}} />
                      <span className="light-text">See Demo</span>
                    </a>
                  )}
                </div>
              </div>
